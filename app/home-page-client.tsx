...
export default function HomePageClient({ faqItems, initialRecommendedData }: HomePageClientProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-4">
        <div className="lg:col-span-2 space-y-6">
          <div className="mb-4 flex items-center justify-between rounded-2xl border border-neutral-800 bg-neutral-950 p-4">
            <div>
              <h1 className="text-2xl font-bold text-white">Live Crypto Feed</h1>
              <p className="text-sm text-neutral-500 mt-1">Latest crypto discussions</p>
            </div>
            <button
              onClick={() => refetch()}
